...
class ContactTest {
	...
	void testContactClassArgs() {
		...
		Assertions.assertThrows(IllegalArgumentException.class, () -> {
			new Contact("123", "bob", "david", "2033442509", "123 Mulberry Street Super Long over 30 characters address." );
		});
	}
	...
	void testContactUpdateMethods() {
		...
		Assertions.assertThrows(IllegalArgumentException.class, () -> {
			contact.setAddress("SuperLongAddressExceedingThirtyCharactersInLength");
		});
		Assertions.assertThrows(IllegalArgumentException.class, () -> {
			contact.setFirstName("");
		});
